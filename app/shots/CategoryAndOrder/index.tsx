...
const CategoryAndOrder = ({ integrationMode=false, noCategory=false }: Props) => {
    ...
    return (
        <div className="relative z-40 flex flex-row items-center justify-center w-full gap-8 px-4 shrink-0 h-fit">
