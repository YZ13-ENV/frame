...
const PortfolioExample = () => {
  return (
    <>
      <div className="w-full h-fit flex items-center justify-center my-64 px-6">
        <h1 className="text-center text-5xl font-bold">Как может выглядеть ваше портфолио</h1>
      </div>
      <AuthorBannerWrapper transparent>
        {/* <StarField /> */}
        <div className="author-banner-wrapper">
          <div className="author-info-wrapper">
              ...
              <span className="author-description">Это может быть вашим портфолио</span>
